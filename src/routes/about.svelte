...
<PageTransition>
	<section>
		<p>
			Rather misty is a simple weather app that shows all the great data from the open meteo
		...
		<p>
			It loads a 7 day per hour forecast and saves it on the device for later usage. It also loads 2
